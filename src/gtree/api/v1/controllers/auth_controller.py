...
from gtree.api.v1.schemas.user import TokenResponseSchema
...
async def login(
    ...
    return TokenResponseSchema.from_entity(
...
async def register(
    ...
    """Register a new user and create access and refresh tokens"""
    return TokenResponseSchema.from_entity(
